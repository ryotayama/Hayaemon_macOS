...
CMainWnd::CMainWnd(CApp & app)
	: m_rApp(app), m_menu(new CMenu_MainWnd(app, *this)),
		m_toolBar(new CToolBar_MainWnd(*this)),
		m_timeLabel(new CTimeLabel_MainWnd(*this)),
		m_timeSlider(new CTimeSlider_MainWnd(*this)),
		m_speedLabel(new CSpeedLabel_MainWnd(*this)),
		m_speedSlider(new CSpeedSlider_MainWnd(*this)),
		m_freqLabel(new CFreqLabel_MainWnd(*this)),
		m_freqSlider(new CFreqSlider_MainWnd(*this)),
		m_pitchLabel(new CPitchLabel_MainWnd(*this)),
		m_pitchSlider(new CPitchSlider_MainWnd(*this)),
		m_volumeLabel(new CVolumeLabel_MainWnd(*this)),
		m_volumeSlider(new CVolumeSlider_MainWnd(*this)),
		m_panLabel(new CPanLabel_MainWnd(*this)),
		m_panSlider(new CPanSlider_MainWnd(*this)),
		m_eq20Label(new CEQLabel_MainWnd(*this)),
		m_eq20Slider(new CEQSlider_MainWnd(*this)),
		m_eq25Label(new CEQLabel_MainWnd(*this)),
		m_eq25Slider(new CEQSlider_MainWnd(*this)),
		m_eq31_5Label(new CEQLabel_MainWnd(*this)),
		m_eq31_5Slider(new CEQSlider_MainWnd(*this)),
		m_eq40Label(new CEQLabel_MainWnd(*this)),
		m_eq40Slider(new CEQSlider_MainWnd(*this)),
		m_eq50Label(new CEQLabel_MainWnd(*this)),
		m_eq50Slider(new CEQSlider_MainWnd(*this)),
		m_eq63Label(new CEQLabel_MainWnd(*this)),
		m_eq63Slider(new CEQSlider_MainWnd(*this)),
		m_eq80Label(new CEQLabel_MainWnd(*this)),
		m_eq80Slider(new CEQSlider_MainWnd(*this)),
		m_eq100Label(new CEQLabel_MainWnd(*this)),
		m_eq100Slider(new CEQSlider_MainWnd(*this)),
		m_eq125Label(new CEQLabel_MainWnd(*this)),
		m_eq125Slider(new CEQSlider_MainWnd(*this)),
		m_eq160Label(new CEQLabel_MainWnd(*this)),
		m_eq160Slider(new CEQSlider_MainWnd(*this)),
		m_eq200Label(new CEQLabel_MainWnd(*this)),
		m_eq200Slider(new CEQSlider_MainWnd(*this)),
		m_eq250Label(new CEQLabel_MainWnd(*this)),
		m_eq250Slider(new CEQSlider_MainWnd(*this)),
		m_eq315Label(new CEQLabel_MainWnd(*this)),
		m_eq315Slider(new CEQSlider_MainWnd(*this)),
		m_eq400Label(new CEQLabel_MainWnd(*this)),
		m_eq400Slider(new CEQSlider_MainWnd(*this)),
		m_eq500Label(new CEQLabel_MainWnd(*this)),
		m_eq500Slider(new CEQSlider_MainWnd(*this)),
		m_eq630Label(new CEQLabel_MainWnd(*this)),
		m_eq630Slider(new CEQSlider_MainWnd(*this)),
		m_eq800Label(new CEQLabel_MainWnd(*this)),
		m_eq800Slider(new CEQSlider_MainWnd(*this)),
		m_eq1kLabel(new CEQLabel_MainWnd(*this)),
		m_eq1kSlider(new CEQSlider_MainWnd(*this)),
		m_eq1_25kLabel(new CEQLabel_MainWnd(*this)),
		m_eq1_25kSlider(new CEQSlider_MainWnd(*this)),
		m_eq1_6kLabel(new CEQLabel_MainWnd(*this)),
		m_eq1_6kSlider(new CEQSlider_MainWnd(*this)),
		m_eq2kLabel(new CEQLabel_MainWnd(*this)),
		m_eq2kSlider(new CEQSlider_MainWnd(*this)),
		m_eq2_5kLabel(new CEQLabel_MainWnd(*this)),
		m_eq2_5kSlider(new CEQSlider_MainWnd(*this)),
		m_eq3_15kLabel(new CEQLabel_MainWnd(*this)),
		m_eq3_15kSlider(new CEQSlider_MainWnd(*this)),
		m_eq4kLabel(new CEQLabel_MainWnd(*this)),
		m_eq4kSlider(new CEQSlider_MainWnd(*this)),
		m_eq5kLabel(new CEQLabel_MainWnd(*this)),
		m_eq5kSlider(new CEQSlider_MainWnd(*this)),
		m_eq6_3kLabel(new CEQLabel_MainWnd(*this)),
		m_eq6_3kSlider(new CEQSlider_MainWnd(*this)),
		m_eq8kLabel(new CEQLabel_MainWnd(*this)),
		m_eq8kSlider(new CEQSlider_MainWnd(*this)),
		m_eq10kLabel(new CEQLabel_MainWnd(*this)),
		m_eq10kSlider(new CEQSlider_MainWnd(*this)),
		m_eq12_5kLabel(new CEQLabel_MainWnd(*this)),
		m_eq12_5kSlider(new CEQSlider_MainWnd(*this)),
		m_eq16kLabel(new CEQLabel_MainWnd(*this)),
		m_eq16kSlider(new CEQSlider_MainWnd(*this)),
		m_eq20kLabel(new CEQLabel_MainWnd(*this)),
		m_eq20kSlider(new CEQSlider_MainWnd(*this)),
		m_sound(new CSound(app, *this)),
		m_soundEffect(new CSound(app, *this, FALSE)),
		isInitFileRead(FALSE), bTimerPlay(FALSE),
		...
		bSetPositionAuto(FALSE), m_bFinish(FALSE), nTimerPlayHour(0),
